...
export function Disciplines() {
  return (
    <section id="practice" className="expertise-scene relative overflow-hidden bg-paper text-ink" aria-labelledby="disc-heading">
      ...
      <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-7 md:px-10 md:py-28 lg:px-12 lg:py-32">
        ...
        <ol className="expertise-list mt-14 border-t border-ink/10 md:mt-20">
          {disciplines.map((item, i) => (
            <li key={item.index} className="discipline-row group relative grid gap-4 border-b border-ink/10 py-7 md:grid-cols-12 md:items-center md:py-9" data-discipline-index={i}>
              ...
              <p className="discipline-copy max-w-xl text-[14px] leading-[1.65] text-ink/62 md:col-span-5">{item.text}</p>
